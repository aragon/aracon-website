...
var HeroBox = _styledComponents2.default.div(_templateObject, medium('min-height: 815px; height: calc(100vh + 64px + 60px);'), _heroBackground2.default, medium('font-size: 24px;'), medium('position: absolute; margin: inherit;'), medium('transform: rotate(90deg); margin-top: inherit;'), medium('transform: rotate(-90deg);'), medium('display: block;'), medium('margin-top: 25px; margin-bottom: 0;'));
...
var Hero = function Hero() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        _ui.Button.Anchor,
        { mode: 'strong', href: 'https://ti.to/aragon/aracon-one/', target: '_blank' },
...
//# sourceMappingURL=static.c1b82eda.js.map