...
const Faq = () => (
  <Page path="/faq">
    ...
    <Container>
        ...
        <FaqBox>
          <Question question="What is AraCon?" answer={<p>AAraCon is the flagship event of the Aragon Project. It is organised by the Aragon Foundation for the Aragon community and anyone interested in the decentralized web, governance, DAOs, and digital jurisdictions.</p>} />
          <Question question="When and where is AraCon happening?" answer={<p>AraCon is taking place
            on 29th-30th January 2019, at <a href="https://www.google.com/maps/place/BOLLE+Fests%C3%A4le/@52.52478,13.34647,15z/data=!4m2!3m1!1s0x0:0xecf15562de88eae5?sa=X&ved=2ahUKEwiJ_q-m99rcAhVBY1AKHW_0C2UQ_BIwDnoECAsQCw" target="_blank" rel="noopener noreferrer">Bolle Festsäle in Berlin, Germany</a>.</p>} />
          <Question question="Why should I attend AraCon?" answer={<p>AraCon will be the best place for you to get a great understanding of Web 3.0 and Aragon. You will discover the latest developments and glimpses of what's to come from our carefully planned program. Every speaker is passionate and deeply involved in creating this decentralized future.<br /><br />The event has four distinctive themes which we'll cover:<br /><br /><li>Aragon</li><li>Web 3.0 / Ethereum</li><li>Decentralized Governance</li><li>DAOs</li></p>} />
