    ...
    <Section>
      <Container>
        ...
        <FaqBox>
          ...
          <Question question="How can my company become an official partner of AraCon?" answer={<p>If you wish your company partner with the conference, contribute in any way, or organise a satellite event, please send us your proposal at <SafeLink href="mailto:info@aracon.org">info@aracon.org</SafeLink>.</p>} />
          <Question question="How can I contact the AraCon team?" answer={<p>You can contact the team via email <SafeLink href="mailto:info@aracon.org">info@aracon.org</SafeLink>.</p>} />
          <Question question="How can I follow AraCon on social media?" answer={<p>You can follow news and updates on AraCon on Twitter via <SafeLink href="https://twitter.com/AragonProject" target="_blank">@AragonProject</SafeLink> and the official hashtag <SafeLink href="https://twitter.com/hashtag/AraConOne" target="_blank">#AraConOne</SafeLink>.<br /><br />You can also <SafeLink href="https://eepurl.com/dHogTD" target="_blank">subscribe to the AraCon email newsletter here</SafeLink>.</p>} />
