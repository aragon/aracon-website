  ...
  <Page path="/faq">
    ...
    <Container>
        ...
        <FaqBox>
          ...
          <Question question="When and where is AraCon happening?" answer={<p>AraCon is taking place on 29th-30th January 2019, at Bolle FestsÃ¤le in Berlin, Germany.</p>} />
          <Question question="Is AraCon free-to-attend?" answer={<p>AraCon is free to attend for Aragon community. To make sure youâ€™re eligible for a free ticket, please check if you meet one of the criteria <a href="/registration">here</a>.</p>} />
