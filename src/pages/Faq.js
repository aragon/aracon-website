  ...
  <Page path="/faq">
    <Section>
      <Container>
        ...
        <FaqBox>
          <Question question="What is AraCon?" answer={<p>AraCon is the flagship event of the Aragon Project. It is organised by the Aragon Association for the Aragon community and anyone interested in the decentralized web, governance, DAOs, and digital jurisdictions.</p>} />
          ...
          <Question question="How many people can attend AraCon?" answer={<div className="wrapper"><p>There will be room for 500 attendees at the venue.</p></div>} />
