      ...
      <SpeakersBox>
        ...
        <Container>
          ...
          <Speaker photo="JordiBaylina" linkTo="jordi" name="Jordi Baylina" position="Tech Lead" company="Iden3"
            bio="Telecommunication Engineering BS by UPC and MBA by IESE. Over 30 years of experience as a developer, and 
            3 years researching Ethereum blockchain. One of the strongest Solidity developers in the world and a high impact 
            contributor in the Ethereum community. He is co-founder of the White Hat Group which played a major role in 
            rescuing funds from TheDAO and Parity Multisig Hacks, author of the MiniMe token contract, the elliptic curves 
            Solidity library as well as numerous other established contracts in the Ethereum space, being ERC-777 the latest 
            standardization work he launched. Well respected auditor, most notably leading teams to audit the MakerDAO Stable 
            Coin system and Aragon project. Founder of the donation platform Giveth, DAppNode and Iden3."/>
